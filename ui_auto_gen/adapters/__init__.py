...
from ui_auto_gen.adapters.ocr import OcrProtectAdapter, PlaceholderOcrProtector
...
from ui_auto_gen.adapters.style import PlaceholderStyleAdapter, StyleAdapter
